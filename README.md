...
This codebase accompanies paper "FOP: Factorizing Optimal Joint Policy of Maximum-Entropy Multi-AgentReinforcement Learning"([link](http://proceedings.mlr.press/v139/zhang21m.html)). The implementation is based on [PyMARL](https://github.com/oxwhirl/pymarl) and [SMAC](https://github.com/oxwhirl/smac) codebases which are open-sourced. 
